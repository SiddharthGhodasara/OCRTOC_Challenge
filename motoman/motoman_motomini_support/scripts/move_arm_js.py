...
if __name__ == "__main__":
	...
	quat_ = arm_group.get_current_pose()
	print(quat_)
	quat = [quat_.pose.orientation.x, quat_.pose.orientation.y, quat_.pose.orientation.z, quat_.pose.orientation.w]
	print(euler_from_quaternion(quat, axes='sxyz'))
