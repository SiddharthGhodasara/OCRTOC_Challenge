...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.graspinput.input_pc.is_dense
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.graspinput.input_pc.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.graspinput.goal_frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_result.result.graspOutput.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
