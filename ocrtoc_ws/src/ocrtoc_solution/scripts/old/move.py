...
pose_target.pose.position.x = -0.144#0.0954864561445#0.144 #round(x,3) - 0.15 #0.70497235  #0.686035203183#0.815497296598
pose_target.pose.position.y = -0.10#0.000101834443899#0.08#round(y,3)#0.05076018 #0.081532898455#-0.00681731667033
pose_target.pose.position.z =  0.127#0.112983920152#0.127#round(z,3) #- 0.01#0.89241191#0.988392256467#1.21581034818#0.966


quat = tf.transformations.quaternion_from_euler(math.atan2(-pose_target.pose.position.y,pose_target.pose.position.x), 1.57,0.0)
