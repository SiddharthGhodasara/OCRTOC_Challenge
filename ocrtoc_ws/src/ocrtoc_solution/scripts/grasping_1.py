...
class Grasping:
    ...
    def get_grasps_coord(self, pose):
        ...
        self.grasp_pose.pose.position.x = pose.pose.position.x#float(self.grasps_plots_max[-4])
        self.grasp_pose.pose.position.y = pose.pose.position.y#float(self.grasps_plots_max[-3])
        self.grasp_pose.pose.position.z = pose.pose.position.z*1.8#$float(self.grasps_plots_max[-2]) + 0.03
