...
bool operator==(const ::haf_grasping::CalcGraspPointsServerAction_<ContainerAllocator1> & lhs, const ::haf_grasping::CalcGraspPointsServerAction_<ContainerAllocator2> & rhs)
{
