...
bool operator==(const ::haf_grasping::CalcGraspPointsServerGoal_<ContainerAllocator1> & lhs, const ::haf_grasping::CalcGraspPointsServerGoal_<ContainerAllocator2> & rhs)
{
  return lhs.graspinput == rhs.graspinput;
}
