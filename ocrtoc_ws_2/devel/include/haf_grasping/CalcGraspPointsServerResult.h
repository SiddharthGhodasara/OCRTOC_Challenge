...
bool operator==(const ::haf_grasping::CalcGraspPointsServerResult_<ContainerAllocator1> & lhs, const ::haf_grasping::CalcGraspPointsServerResult_<ContainerAllocator2> & rhs)
{
  return lhs.graspOutput == rhs.graspOutput;
}
